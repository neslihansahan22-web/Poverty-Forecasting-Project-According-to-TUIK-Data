...
15. Clone or download the project repository.
16. Open poverty_forecasting_project.Rproj in RStudio.
17. Open forecasting_project.Rmd.
18. Click the "Knit" button in RStudio to render the notebook to HTML.
